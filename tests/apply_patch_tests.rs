...
fn test_apply_patch_removes_minus_lines() {
    ...
    assert!(
        !stdout.contains("bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb"),
...
fn test_apply_patch_adds_plus_lines() {
    ...
    assert!(
        stdout.contains("9999999999999999999999999999999999999999999999999999999999999999"),
...
fn test_apply_patch_preserves_unchanged_entries() {
    ...
    let stdout = String::from_utf8_lossy(&out.stdout);
    assert!(
        stdout.contains("unchanged.txt"),
        "unchanged entry must be preserved"
    );
    assert!(
